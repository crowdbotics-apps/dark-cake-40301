"""
Django settings for dark_cake_40301 project.
...
ROOT_URLCONF = 'dark_cake_40301.urls'
...
WSGI_APPLICATION = 'dark_cake_40301.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dark_cake_40301 API",
    "DESCRIPTION": "API documentation for dark_cake_40301 App",
    "VERSION": "v1",
}
